...
*/
fn main(){
  //The syntax of a closure is: || { code }, and they can be assigned to a variable.
  ...
  //example5 - capturing by mutably borrowing
  let mut y = 1;
  ...
  // println!("{}", z); //error: value borrowed here after move
